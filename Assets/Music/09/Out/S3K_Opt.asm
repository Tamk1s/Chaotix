SB_City_Header:
	...
	sHeaderPSG	SB_City_PSG1, $0C, $05, $00, $2B
	sHeaderPSG	SB_City_PSG2, $0C, $05, $00, $2B
	sHeaderPSG	SB_City_PSG3, $0C, $05, $00, $2D
