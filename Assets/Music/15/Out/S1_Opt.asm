	...
	smpsHeaderPSG	HDNR1S_PSG1, Target, $00, $05, $00, $00
	smpsHeaderPSG	HDNR1S_PSG2, Target, $00, $0B, $00, $00
	smpsHeaderPSG	HDNR1S_PSG3, Target, $00, $0A, $00, $00
...
HDNR1S_Loo$8:
	dc.b	nRst, $54
	smpsLoop		$00, $07, HDNR1S_Loo$8, Target
	smpsAlterNote	$00

HDNR1S_Loo$9:
	dc.b	$55, $0A, $01, $2F, $01, $2F, $01
	smpsLoop		$00, $02, HDNR1S_Loo$9, Target

HDNR1S_Loop10:
	dc.b	$4E
	smpsLoop		$00, $07, HDNR1S_Loop10, Target
	dc.b	$55, $55, $55, $03
	smpsJump		HDNR1S_Loo$8, Target
...
HDNR1S_Loo$80:
	...
	smpsLoop		$02, $07, HDNR1S_Loo$80, Target
	dc.b	nA1, $03
...
HDNR1S_Loo$81:
	...
	dc.b	$02
	smpsLoop		$00, $02, HDNR1S_Loo$81, Target
	dc.b	nRst, $01, nC3, $03
	smpsLoop		$01, $08, HDNR1S_Loo$82, Target
	dc.b	$02, nRst, $01
	smpsAlterVol		$03
	dc.b	nD4, $02, $01, $02, nRst, $04
	smpsAlterVol		$06
...
HDNR1S_Loo$83:
	dc.b	$02, nRst, $07, nD4, $02, $01
	smpsLoop		$00, $02, HDNR1S_Loo$83, Target
	dc.b	$02, nRst, $01
	smpsAlterVol		$06
	dc.b	nD4, $03, nRst, nD4, nRst, $06
	smpsAlterVol		$FA
...
HDNR1S_Loo$84:
	dc.b	nD4, $02, $01, $02, nRst, $01
	smpsLoop		$00, $02, HDNR1S_Loo$84, Target
	dc.b	nC4, $02, $01, $02, nRst, $01
	smpsAlterVol		$06
	dc.b	nC4, $03, nRst, nC4, nRst, $06
	smpsAlterVol		$FA
...
HDNR1S_Loo$85:
	dc.b	nC4, $02, $01, $02, nRst, $01
	smpsLoop		$00, $02, HDNR1S_Loo$85, Target
	dc.b	nCs4, $02, $01, $02, nRst, $01
	smpsAlterVol		$06
	dc.b	nCs4, $03, nRst, nCs4, nRst
	smpsAlterVol		$FA
...
HDNR1S_Loo$86:
	dc.b	$4F
	smpsLoop		$00, $07, HDNR1S_Loo$86, Target
	dc.b	$02
	smpsFMvoice		$02
	dc.b	$06
	smpsAlterVol		$FD
...
HDNR1S_Loo$87:
	...
	dc.b	nCs5, $09, nRst, $03, nBb4, $09, nRst, $03
	smpsLoop		$00, $02, HDNR1S_Loo$87, Target
...
HDNR1S_Loo$88:
	...
	dc.b	$03
	smpsAlterVol		$0B
	smpsLoop		$00, $18, HDNR1S_Loo$88, Target
	dc.b	nE3
	smpsAlterVol		$F5
	dc.b	$03
	smpsAlterVol		$0A
...
HDNR1S_Loo$89:
	...
	dc.b	$01
	smpsLoop		$00, $02, HDNR1S_Loo$89, Target
...
HDNR1S_Loo$90:
	...
	dc.b	$02
	smpsLoop		$00, $02, HDNR1S_Loo$90, Target
	dc.b	nRst, $01, nD3, $03, $02

HDNR1S_Loo$91:
	dc.b	nRst, $01, nC3, $03, $02, nRst, $01, nC3
	dc.b	$02
	smpsLoop		$00, $02, HDNR1S_Loo$91, Target
	dc.b	nRst, $01, nC3, $03, $02

HDNR1S_Loo$92:
	dc.b	nRst, $01, nBb2, $03, $02, nRst, $01, nBb2
	dc.b	$02
	smpsLoop		$00, $02, HDNR1S_Loo$92, Target
	dc.b	nRst, $01, nBb2, $03, $02

HDNR1S_Loo$93:
	dc.b	nRst, $01, nE3, $03, $02, nRst, $01, nE3
	dc.b	$02
	smpsLoop		$00, $02, HDNR1S_Loo$93, Target
...
HDNR1S_Loo$94:
	dc.b	nA2, $03, $02, nRst, $01, nA2, $02, nRst
	dc.b	$01
	smpsLoop		$00, $02, HDNR1S_Loo$94, Target
	dc.b	nA2, $03, $02, nRst, $01, nA2, $03, $02
	dc.b	nRst, $01, nA2, $02, nRst, $01, nC3, $03
	dc.b	$02, nRst, $01, nC3, $02, nRst, $01, nEb3
	dc.b	$03, $02, nRst, $01, nD3, $03, $02, nRst
...
HDNR1S_Loo$95:
	dc.b	nRst, $01, nD3, $03, $02, nRst, $01, nD3
	dc.b	$02
	smpsLoop		$00, $02, HDNR1S_Loo$95, Target
	dc.b	nRst, $01, nD3, $03, $02

HDNR1S_Loo$96:
	dc.b	nRst, $01, nC3, $03, $02, nRst, $01, nC3
	dc.b	$02
	smpsLoop		$00, $02, HDNR1S_Loo$96, Target
	dc.b	nRst, $01, nC3, $03, $02

HDNR1S_Loo$97:
	dc.b	nRst, $01, nBb2, $03, $02, nRst, $01, nBb2
	dc.b	$02
	smpsLoop		$00, $02, HDNR1S_Loo$97, Target
	dc.b	nRst, $01, nBb2, $03, $02

HDNR1S_Loo$98:
	dc.b	nRst, $01, nD3, $03, $02, nRst, $01, nD3
	dc.b	$02
	smpsLoop		$00, $02, HDNR1S_Loo$98, Target
...
HDNR1S_Loo$99:
	...
	smpsLoop		$00, $02, HDNR1S_Loo$99, Target
	dc.b	$02, nRst, $01
	smpsAlterVol		$06
