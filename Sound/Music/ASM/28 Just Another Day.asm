...
PWMVol	EQU	$88
	...
	smpsHeaderFM	Nepu_DimTrip_FM1, Target, FMPitch, FMVol1
	smpsHeaderFM	Nepu_DimTrip_FM2, Target, FMPitch, FMVol1
	smpsHeaderFM	Nepu_DimTrip_FM3, Target, FMPitch, FMVol2
	smpsHeaderFM	Nepu_DimTrip_FM4, Target, FMPitch, FMVol1
	smpsHeaderFM	Nepu_DimTrip_FM5, Target, FMPitch, FMVol1
	smpsHeaderFM	Nepu_DimTrip_FM6, Target, FMPitch, FMVol1
	smpsHeaderPSG	Nepu_DimTrip_PSG1, Target, PSGPitch, PSGVol1, PSGMod, PSGVoi1
	smpsHeaderPSG	Nepu_DimTrip_PSG2, Target, PSGPitch, PSGVol2, PSGMod, PSGVoi1
	smpsHeaderPSG	Nepu_DimTrip_PSG3, Target, PSGPitch, PSGVol2, PSGMod, PSGVoi1
	smpsHeaderPWM	Nepu_DimTrip_PWM1, Target, PWMPitch, PWMVol
	smpsHeaderPWM	Nepu_DimTrip_PWM2, Target, PWMPitch, PWMVol
	smpsHeaderPWM	Nepu_DimTrip_PWM3, Target, PWMPitch, PWMVol
	smpsHeaderPWM	Nepu_DimTrip_PWM4, Target, PWMPitch, PWMVol
...
Nepu_DimTrip_Loop8:
	dc.b $04, nRst
	smpsLoop		$00, $07, Nepu_DimTrip_Loop8, Target
	dc.b nE2, $08, $04, nRst, $14, $08, $04, nRst
	dc.b $14, nD2, $08, $04, nRst, $14, nA2, $08
	dc.b $04, nRst, $14, nB2, $08
...
Nepu_DimTrip_Loop9:
	dc.b $04, nRst
	smpsLoop		$00, $07, Nepu_DimTrip_Loop9, Target
	dc.b nF2, $08
...
Nepu_DimTrip_PWM1_Loop8:
	dc.b	pAKick, $08, $04, pASnare, $08, pAKick, $04, $04
	dc.b	pASnare
	smpsLoop		$00, $02, Nepu_DimTrip_PWM1_Loop8, Target
...
Nepu_DimTrip_PWM1_Loop9:
	dc.b	pASnare, $04, pAKick, $08, $04, pASnare, $08, $04
	dc.b	pEKick, $02, pAKick
	smpsLoop		$00, $02, Nepu_DimTrip_PWM1_Loop9, Target
	dc.b	pASnare, $04
...
Nepu_DimTrip_Patches:
	...
	dc.b	$36, $25, $26, $29,	$1F, $1E, $19, $80

	; Patch $01
	dc.b	$3A
	dc.b	$23, $72, $22, $32,	$1F, $1F, $1F, $1F
	dc.b	$05, $05, $05, $0B,	$05, $05, $05, $05
	dc.b	$11, $18, $11, $18,	$1C, $15, $1E, $82

	; Patch $02
	dc.b	$2A
	dc.b	$50, $03, $11, $00,	$90, $CE, $CD, $9B
	dc.b	$05, $0A, $09, $08,	$00, $00, $12, $0C
	dc.b	$09, $FF, $50, $4A,	$18, $27, $25, $80

	; Patch $03
	dc.b	$10
	dc.b	$35, $76, $70, $30,	$DF, $DF, $5F, $5F
	dc.b	$06, $08, $09, $09,	$06, $03, $03, $01
	dc.b	$26, $16, $06, $26,	$21, $34, $19, $80
