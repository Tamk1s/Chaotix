...
PSGVol2		EQU	$0C-$06
	...
	smpsHeaderFM	HDN_BlueTwl_FM1, Target, $00, $14-$07
	smpsHeaderFM	HDN_BlueTwl_FM2, Target, $00, $1F-$07
	smpsHeaderFM	HDN_BlueTwl_FM3, Target, $00, $0F+$07
	smpsHeaderFM	HDN_BlueTwl_FM4, Target, $00, $15+$07
	smpsHeaderFM	HDN_BlueTwl_FM5, Target, $00, $14
	smpsHeaderFM	HDN_BlueTwl_FM6, Target, $00, $1F
	smpsHeaderPSG	HDN_BlueTwl_PSG1, Target, PSGDelta, PSGVol0, $00, PSGVoi0
	smpsHeaderPSG	HDN_BlueTwl_PSG2, Target, PSGDelta, PSGVol1, $00, PSGVoi0
	smpsHeaderPSG	HDN_BlueTwl_PSG3, Target, PSGDelta, PSGVol2, $00, PSGVoi1
	smpsHeaderPWM	HDN_BlueTwl_PWM1, Target, PWMPitch, PWMVol1
	smpsHeaderPWM	HDN_BlueTwl_PWM2, Target, PWMPitch, PWMVol2
	smpsHeaderPWM	HDN_BlueTwl_PWM3, Target, PWMPitch, PWMVol1
	smpsHeaderPWM	HDN_BlueTwl_PWM4, Target, PWMPitch, PWMVol1
...
HDN_BlueTwl_FM6:
	smpsPan		panRight
	smpsFMvoice		$02
	dc.b	nA2, $2E, nRst, $02, nG2, $2E, nRst, $02
	dc.b	nF2, $2E, nRst, $02, nB2, $2E, nRst, $02
	dc.b	nA2, $2E, nRst, $02, nG2, $2E, nRst, $02
	dc.b	nF2, $2E, nRst, $02, nE2, $2E, nRst, $02
	dc.b	nE2, $2E, nRst, $02, nD2, $2E, nRst, $02
	dc.b	nC2, $2E, nRst, $02, nD2, $2E, nRst, $02
	dc.b	nG2, $2E, nRst, $02, nA2, $2E, nRst, $02
	dc.b	nB2, $2E, nRst, $02, nAb2, $2E, nRst, $02
	dc.b	nE2, $2E, nRst, $02, nD2, $2E, nRst, $02
	dc.b	nC2, $2E, nRst, $02, nD2, $2E, nRst, $02
	dc.b	nG2, $2E, nRst, $02, nA2, $2E, nRst, $02
	dc.b	nAb2, $2E, nRst, $02, nA2, $2E, nRst, $02
	dc.b	nA2, $2E, nRst, $02, nG2, $2E, nRst, $02
	dc.b	nF2, $2E, nRst, $02, nB2, $2E, nRst, $02
	dc.b	nA2, $2E, nRst, $02, nG2, $2E, nRst, $02
	dc.b	nF2, $2E, nRst, $02, nE2, $2E, nRst, $02
	dc.b	nBb2, $2E, nRst, $02, nF2, $2E, nRst, $02
	dc.b	nEb2, $2E, nRst, $02, nG2, $2E, nRst, $02
	dc.b	nC2, $2E, nRst, $02, nF2, $2E, nRst, $02
	dc.b	nC2, $2E, nRst, $02, nB1, $2E, nRst, $02
	dc.b	nAb2, $2E, nRst, $02, nBb2, $2E, nRst, $02
	dc.b	nB2, $2E, nRst, $02, nC2, $2E, nRst, $02
	dc.b	nC2, $2E, nRst, $02, nF2, $2E, nRst, $02
	dc.b	nEb2, $06, nBb3, nAb3, nRst, nF2, $17, nRst
	dc.b	$01, nC3, $2E, nRst, $09
	smpsJump		HDN_BlueTwl_FM6, Target
